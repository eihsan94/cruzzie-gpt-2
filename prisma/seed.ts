...
async function main() {
  ...
  const notion = await prisma.action.create({
    data: {
      ...
      oAuth2:
        "https://api.notion.com/v1/oauth/authorize?client_id=99976230-59c1-4290-af74-a06966762cdc&response_type=code&owner=user",
      imageUrl:
